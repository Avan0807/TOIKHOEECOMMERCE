<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapsedoc" class="collapse" aria-labelledby="headingBacSi" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Tùy chọn bác sĩ:</h6>
    ...
    <!--Đánh giá -->
    <li class="nav-item">
        <a class="nav-link" href="{{route('doctor-review.index')}}">
