                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('password.phone') }}">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user @error('phone') is-invalid @enderror" id="exampleInputPhone" placeholder="Nhập số điện thoại..." name="phone" value="{{ old('phone') }}" required autofocus>
                        @error('phone')
