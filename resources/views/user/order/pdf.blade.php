...
<style type="text/css">
  ...
  <div class="invoice-header">
    <div class="float-left site-logo">
      <img src="{{asset('backend/img/logo.webp')}}" alt="">
    </div>
  ...
  <div class="invoice-description">
    ...
    <div class="invoice-right-top float-right" class="text-right">
      ...
      {{-- <img class="img-responsive" src="data:image/webp;base64, {{ base64_encode(QrCode::format('webp')->size(150)->generate(route('admin.product.order.show', $order->id )))}}"> --}}
    </div>
    <div class="clearfix"></div>
  </div>
